...
VOLUNTARYCHECK=0
I=1
BOT=KnightTeambot  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m                    by CleverBoy                 \e[00;37;40m"
echo ""
cat << EOF
...
echo ""
echo -e "\033[38;5;208m @KnightTeam    :)      @KnightTeam \033[0;00m"
echo -e "\033[38;5;208m @KnightTeam    :)      @KnightTeam \033[0;00m"
echo -e "\033[38;5;208m @KnightTeam    :)      @KnightTeam \033[0;00m"
echo -e "\033[38;5;208m @KnightTeam    :)      @KnightTeam \033[0;00m"
echo -e "\033[38;5;208m @KnightTeam    :)      @KnightTeam \033[0;00m"
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1 KnightTeam 2016 CleverBoy" >&2
	echo ""
	echo -e "\e[0m"
